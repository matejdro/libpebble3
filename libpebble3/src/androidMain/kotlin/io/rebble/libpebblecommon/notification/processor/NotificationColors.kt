...
object HardcodedNotificationColors {
    val packageColorMap = mapOf(
        ...
        "xyz.blueskyweb.app" to 0xFF00AAFF.toInt(),
        "com.duolingo" to 0xFF00AA00.toInt(),
        "im.vector.app" to 0xFF55FFAA.toInt(),
        "io.element.android.x" to 0xFF55FFAA.toInt(),
        "com.google.android.apps.dynamite" to 0xFF00AA00.toInt(),
        "com.google.android.apps.tasks" to 0xFF0055FF.toInt(),
        "io.homeassistant.companion.android" to 0xFF00AAFF.toInt(),
        "com.valvesoftware.android.steam.community" to 0xFF0055AA.toInt(),
        "com.microsoft.teams" to 0xFF5500AA.toInt(),
        "com.instagram.barcelona" to 0xFF555555.toInt(),
        "com.ubnt.unifi.protect" to 0xFF0055FF.toInt(),
        "us.zoom.videomeetings" to 0xFF00AAFF.toInt(),
        "com.ebay.mobile" to 0xFFFF0000.toInt(),
